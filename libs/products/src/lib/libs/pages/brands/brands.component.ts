...
export class BrandsComponent implements OnInit, OnDestroy {
  ...
  brandLogos: { [key: string]: string } = {
    ...
    Chanel:
      'https://logos-world.net/wp-content/uploads/2020/04/Chanel-Logo.png',
    Coach: 'https://logos-world.net/wp-content/uploads/2020/04/Coach-Logo.png',
    'Michael Kors':
      'https://logos-world.net/wp-content/uploads/2020/04/Michael-Kors-Logo.png',
    'Jimmy Choo':
      'https://logos-world.net/wp-content/uploads/2020/04/Jimmy-Choo-Logo.png',
    Converse:
      'https://logos-world.net/wp-content/uploads/2020/04/Converse-Logo.png',
    'Dr. Martens':
      'https://www.drmartens.com/on/demandware.static/Sites-GB-Site/-/default/dw3c8b4c6b/images/logos/logo.svg',
    YSL: 'https://logos-world.net/wp-content/uploads/2020/04/Yves-Saint-Laurent-Logo.png',
    'Saint Laurent':
      'https://logos-world.net/wp-content/uploads/2020/04/Yves-Saint-Laurent-Logo.png',
    Dior: 'https://logos-world.net/wp-content/uploads/2020/04/Dior-Logo.png',
    'Kate Spade':
      'https://logos-world.net/wp-content/uploads/2020/04/Kate-Spade-Logo.png',
    'Marc Jacobs':
      'https://logos-world.net/wp-content/uploads/2020/04/Marc-Jacobs-Logo.png',
    'Tory Burch':
      'https://logos-world.net/wp-content/uploads/2020/04/Tory-Burch-Logo.png',
    ...
    'Christian Louboutin':
      'https://logo.clearbit.com/christianlouboutin.com?size=200',
    'Nicholas Kirkwood':
      'https://logo.clearbit.com/nicholaskirkwood.com?size=200',
    'Manolo Blahnik': 'https://logo.clearbit.com/manoloblahnik.com?size=200',
    'Stella McCartney':
      'https://logo.clearbit.com/stellamccartney.com?size=200',
    ...
    'L.L.Bean':
      'https://logos-world.net/wp-content/uploads/2020/04/LL-Bean-Logo.png',
  ...
  getBrandLogo(brandName: string): string {
    return (
      this.brandLogos[brandName] ||
      'https://via.placeholder.com/80x80?text=' + encodeURIComponent(brandName)
    );
  }
